...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Kantuta POS - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Kantuta POS - React.js Tailwind CSS Admin Dashboard Template"
      />
