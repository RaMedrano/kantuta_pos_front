...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Kantuta POS - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Kantuta POS - React.js Tailwind CSS Admin Dashboard Template"
      />
